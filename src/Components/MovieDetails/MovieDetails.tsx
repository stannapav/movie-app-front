  ...
  useEffect(() => {
    const fetchPoster = async () => {
      if (movie?.imdbId) {
        try {
          const response = await axios.get(
            `http://www.omdbapi.com/?i=${movie.imdbId}&apikey=${OMDB_KEY}`
          );
    ...
    <>
      ...
      <div className="movie-details-container">
        ...
        <div className="movie-details-content">
            ...
            <div className="watch-status-buttons">
              <button
                className={`watch-status-btn ${
                  watchStatus === WatchStatus.WATCHED ? "active" : ""
                }`}
              ...
              <button
                className={`watch-status-btn ${
                  watchStatus === WatchStatus.WATCH_LATER ? "active" : ""
                }`}
              ...
              <button
                className={`watch-status-btn ${
                  watchStatus === WatchStatus.DROPPED ? "active" : ""
                }`}
          ...
          <p>
            <b>Rating:</b> {movie.voteAverage} ({movie.voteCount} votes)
          </p>
          <p>
            <b>Genres:</b> {movie.genreNames.join(", ")}
          </p>
          <p>
            <b>Production Countries:</b>{" "}
            {movie.productionCountryNames.join(", ")}
          </p>
          <p>
            <b>Production Companies:</b>{" "}
            {movie.productionCompanyNames.join(", ")}
          </p>
          <p>
